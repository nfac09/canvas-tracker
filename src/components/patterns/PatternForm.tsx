...
const inputCls = 'w-full rounded-lg border-slate-200 dark:border-white/[0.1] bg-white dark:bg-white/[0.06] text-slate-900 dark:text-slate-100 text-sm focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors'
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="rounded border-slate-200 dark:border-white/[0.15] text-indigo-600 focus:ring-indigo-500/50"
          />
